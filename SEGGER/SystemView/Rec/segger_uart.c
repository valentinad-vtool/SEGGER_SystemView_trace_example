...
#define OFF_SR              0x14        // Status register
#define OFF_DR              0x1C        // Data register
#define OFF_BRR             0x10        // Baudrate register
#define OFF_CR              0x18        // Control register

#endif // LPUART_HAL
#endif // SEGGER_UART_NXP
